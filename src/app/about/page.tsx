        ...
        <div className="flex flex-wrap items-center ">
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="lg:max-w-md">
              <span className="text-xl font-semibold text-gray-600 uppercase">
                About Us
              </span>
          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="flex">
              <span className="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-6 bg-gray-500 rounded text-gray-50">
                <svg
              ...
              <div>
                ...
                <p className="text-base leading-loose text-gray-500">
                  To bring Employers and Freelancers together from around the
                  globe to get work done.
                </p>
              </div>
            </div>
            <div className="flex mt-4">
              ...
              <div>
                ...
                <p className="text-base leading-loose text-gray-500 ">
                  To help build a better world that's interconnected for
                  prosperity and wired for peace.
                </p>
              </div>
            </div>
            <div className="flex mt-4">
